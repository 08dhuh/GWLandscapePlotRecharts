...
const aliases = {
  ...
  'Mass(2)': 'Mass2',
  'SystemMass': 'System Mass',
  'Mass_CO_Core(1)': 'CO core1',
  'Mass_CO_Core(2)': 'CO core2',
  'Mass_He_Core(1)': 'HE core1',
  'Mass_He_Core(2)': 'HE core2',
  'Time': 'Time',
};
const xkey = 'Time';
...
// };
const strokeStyle = {
  'Mass(1)': { stroke: 'red', strokeWidth: '2' },
  'Mass(2)': { stroke: 'blue', strokeWidth: '2' },
  'SystemMass': { stroke: 'black', strokeWidth: '2' },
  'Mass_CO_Core(1)': { stroke: 'red', strokeDasharray: "5 5", strokeWidth: '2' },
  'Mass_CO_Core(2)': { stroke: 'blue', strokeDasharray: "5 5", strokeWidth: '2' },
  'Mass_He_Core(1)': { stroke: 'red', strokeDasharray: "1 1 3", strokeWidth: '2' },
  'Mass_He_Core(2)': { stroke: 'blue', strokeDasharray: "1 1 3", strokeWidth: '2' },
};
export default function RenderMassContainer(props) {
  const { divStyle, syncId } = props;
  const [domain, setDomain] = useState(initialDomain);
  const data = DataUtil(props.rawdata,'Mass');
  console.log(data)
